...
<div class="card bg-dark border-light" style="width: 19rem;">
  <div class="card-body text-white">
    ...
    <a href="/pages/{{$page['id']}}" class="btn btn-light text-dark font-weight-bold">Show</a>
    <a href="/pages/{{$page['id']}}/edit" class="btn btn-success text-light font-weight-bold">Edit</a>
    <form class="float-right" method="POST" action="/pages/{{$page['id']}}">
      @csrf
      @method('DELETE')
